...
public class Numbers_7a_find_sums_Tests {
    ...
    void test700_find_sums_regular() {
        Collection<Pair> actual = testObj.findSums(NumbersImpl.numb_1, 10);
        int[][] expected = {{8, 2}};
    ...
    void test701_find_sums_regular() {
        Collection<Pair> actual = testObj.findSums(NumbersImpl.numb_1, 12);
    ...
    void test702_find_sums_regular() {
        Collection<Pair>  actual = testObj.findSums(NumbersImpl.numb_1, 15);
    ...
    void test703_find_sums_regular() {
        Collection<Pair>  actual = testObj.findSums(NumbersImpl.numb_1, 150);
    ...
    void test704_find_sums_regular() {
        Collection<Pair> actual = testObj.findSums(NumbersImpl.numb_2, 663);
        int[][] expected = {{636, 27}};
        assertTrue(Matchers.matchIgnoreOrder(expected, actual));
    }
    ...
    void test705_find_sums_regular() {
        Collection<Pair> actual = testObj.findSums(NumbersImpl.numb_3, 961);
    ...
    void test706_find_sums_regular() {
        Collection<Pair> actual = testObj.findSums(NumbersImpl.numb_3, 2286);
        int[][] expected = {};  // no solution
        assertTrue(Matchers.matchIgnoreOrder(expected, actual));
    }
}